class ZscalerTerraformer < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 "32e80100ae9b97ab4b9bc572f9e37292f620ade646933664a863d201e42af777"
  end
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    sha256 "0e85e9d430c74208cc5ff2e6cfd2a30dc6ba23f67bc2f6407d53f54ef3abcf39"
  end
  ...
  if OS.linux? && Hardware::CPU.intel?
    ...
    sha256 "002c78938f697346e4df7bb2df3d456ac17a75c1af6b9cdd21ff13696f33a48e"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    ...
    sha256 "9ce2c7025e14c9bc1a938dcf51aa454fe1777c7a24661f4526af94de082b02ba"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    ...
    sha256 "37ff190c0cb458cb08de826dc98e15dd1bf84a53120d493fc4c2221cf2963d48"
  end
