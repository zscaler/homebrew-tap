...
cask "zscaler-terraformer" do
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 "6cfec1594bebcd4e7271b9c2bb9ca600788f13475f6e3b2e60f6a6a3339c2a4b"
  end
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    sha256 "ce445de9d92dc1f6b8efeaffa732157cc3fe449a52142113099b7cc6911c41ff"
  end
  ...
  if OS.linux? && Hardware::CPU.intel?
    ...
    sha256 "b192705115601aa34794c7cba17309f9a051f6657618cf5b65214a8888b66c96"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    ...
    sha256 "7142314fb1257c8a9ca573d161a75a0246ea512d94cf5f51fd14b22262b21603"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    ...
    sha256 "75393af7796470eed5b598126dbbb16db833f11a5e99790a98626db432ce680f"
  end
