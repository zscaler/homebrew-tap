...
cask "zscaler-terraformer" do
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 "f47cad7e607ed251e4bde4200982be2cb962e2e7bc30e3c1efe27699f35b3b2b"
  end
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    sha256 "755af971f2a94c780d29fa4935ce535f09fcd735288dcbf4115cac230f84828b"
  end
  ...
  if OS.linux? && Hardware::CPU.intel?
    ...
    sha256 "24965724ac9d6564166799e104b281a8b8f3e2c1502436aae356149dff386acc"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    ...
    sha256 "bcea2b515e81e1867db1c4add6af9f95d2794c440944bb02bbb9034a323e4132"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    ...
    sha256 "e45ca7b260dc3c5ad07ea2dcb83f7d08d3d83642a149c7b2631db327ccc0299d"
  end
