class ZscalerTerraformer < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 "1c651da4d0b02b4aa898dded07d7bdf2644733aa34253f8d4899d832beaad856"
  end
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    sha256 "9e686d0234b23d53d98201436d085c6819e3c2dcbd5bdf400c2f5db977a5baad"
  end
  ...
  if OS.linux? && Hardware::CPU.intel?
    ...
    sha256 "dd559c7c669db28e12cf2c5139b22fd04d367f37c781a693b86294e66e05b009"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    ...
    sha256 "54ed2c339341982ebed824cdf8bb9ced21bb9bd8298ea5c29483c86c990c629b"
  end
  ...
  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    ...
    sha256 "e79717ff5b9f723675d4aebb7a3f5a691f33ff2d2e46a52b42004a5254e2162d"
  end
